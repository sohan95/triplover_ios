...
struct CountryCodeList: View {
    ...
    @State var list : [Country] = [Country]()
    
//    @Environment(\.presentationMode) var presentationMode
//    var selectedModel: CountryCodeMode
    
//    typealias Action = (Country) -> Void
//    var action: Action?
    ...
    var body: some View {
        List(list) { county in
            VStack{
                Text(county.name!)
                Text(county.countryCode!)
                if county.extensionCode != nil {
                    Text(county.extensionCode!)
                }
            }
...
struct CountryCodeList_Previews: PreviewProvider {
    static var previews: some View {
        CountryCodeList(selectedModel:CountryCodeMode(title: "abc"))
    }
}
...
class Country: Hashable, Codable {
